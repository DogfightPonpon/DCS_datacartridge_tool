...
if __name__ == "__main__":
    ...
    wpt3 = Waypoint(alt=493, name="waplt_1", coords = coord1, obj_type = "ARMY", cap_d=167, pente_d=3)
    wpt2 = Waypoint(alt=15453, name="waplt_2", coords = coord2, obj_type = "FARP", pente_d=3.5)
    objs = {wpt1, wpt2, wpt3}
